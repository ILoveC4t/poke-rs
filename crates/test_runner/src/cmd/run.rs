...
pub fn execute(args: RunArgs) {
    ...
    println!(
        "Cargo Tests: {} passed, {} failed, {} ignored",
        summary.cargo_test.passed, summary.cargo_test.failed, summary.cargo_test.ignored
    );
    if summary.fixture_results.passed + summary.fixture_results.failed > 0 {
        println!(
            "Fixtures:    {} passed, {} failed, {} skipped",
            summary.fixture_results.passed,
            summary.fixture_results.failed,
            summary.fixture_results.skipped
        );
    }

    if !summary.failures.is_empty() {
        println!(
            "\n{} failures detected. See full report in:",
