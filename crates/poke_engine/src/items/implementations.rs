...
pub fn on_modify_bp_mystic_water(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_miracle_seed(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_never_melt_ice(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_black_belt(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_poison_barb(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_sharp_beak(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_twisted_spoon(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_silver_powder(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_hard_stone(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_dragon_fang(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_black_glasses(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_metal_coat(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_silk_scarf(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_flame_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_splash_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_meadow_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_icicle_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_fist_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_toxic_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_earth_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_mind_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_insect_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_stone_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_spooky_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_draco_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_dread_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_iron_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_bp_pixie_plate(
    _state: &BattleState,
    _attacker: usize,
    _defender: usize,
    _move_data: &Move,
...
pub fn on_modify_speed_choice_scarf(_state: &BattleState, _entity: usize, speed: u16) -> u16 {
    // 1.5x (Speed * 3 / 2)
    (speed as u32 * 3 / 2).min(u16::MAX as u32) as u16
}

// Iron Ball: 0.5x Speed
pub fn on_modify_speed_iron_ball(_state: &BattleState, _entity: usize, speed: u16) -> u16 {
    speed / 2
}
...
pub fn on_check_grounded_air_balloon(_state: &BattleState, _entity: usize) -> Option<bool> {
    Some(false)
}

// Iron Ball: Grounded (returns Some(true))
pub fn on_check_grounded_iron_ball(_state: &BattleState, _entity: usize) -> Option<bool> {
    Some(true)
}
